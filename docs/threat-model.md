...
signed request verification, webhook replay prevention, idempotency keys, strict workspace
isolation, append-only audit events, mandatory dry-runs, rollback/compensation, approval
